        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UploadedByName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Webhooks_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    TriggerEntity = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tasks_EntityType_EntityId",
                table: "Tasks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Webhooks_ClientId",
                table: "Webhooks",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_Webhooks_EntityType",
                table: "Webhooks",
                column: "EntityType");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Workflows_TriggerEntity",
                table: "Workflows",
                column: "TriggerEntity");

            migrationBuilder.CreateIndex(
                name: "IX_Workflows_TriggerEvent",
                table: "Workflows",
                column: "TriggerEvent");
        }
